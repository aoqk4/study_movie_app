...
function YouTube() {
  return (
    <>
        ...
        <div className="yt__main">
          ...
          <p className="main__info">
            ...
            <div className="main__right">
              <article className="main__textcon">
                냐옹냐옹냐옹냐옹냐옹냐옹냐옹냐옹냐옹냐옹냐옹냐옹냐옹냐옹냐옹냐옹
                <span className="main__moreimg">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
              ...
              <section className="main__subcon">123</section>
            </div>
          </p>
        </div>
        <div className="maintoshorts"></div>
        <div className="yt__shorts">
          <h3 className="shorts__head">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
          ...
          <div className="shorts__content">
            <div className="content__video">
              <img
                src="https://img.seoul.co.kr/img/upload/2022/03/19/SSI_20220319133828_O2.jpg"
                width={250}
                height={300}
              ></img>
              <div className="content__text">
                123122342424223123123
                <div className="conent__text2">조회수 : </div>
              </div>
            </div>
            <div className="content__video">
              <img
                src="https://www.sisain.co.kr/news/photo/202109/45623_82189_2148.jpg"
                width={250}
                height={300}
              ></img>
              <div className="content__text">
      ...
      <div className="fixed__">
        <div className="yt__menu">
